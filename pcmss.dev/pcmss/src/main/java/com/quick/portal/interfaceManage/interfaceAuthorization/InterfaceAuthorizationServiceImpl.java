 ...
 * <h3>描述 : InterfaceAuthorization服务实现类</h3>
 ...
 */
 @Transactional
 @Service("interfaceAuthorizationService")
public class InterfaceAuthorizationServiceImpl extends SysBaseService<InterfaceAuthorizationDO> implements IInterfaceAuthorizationService {
    ...
    @Autowired
    private IInterfaceAuthorizationDao dao;
     ...
     */
    @Override
    public DataStore save(InterfaceAuthorizationDO entity) {
