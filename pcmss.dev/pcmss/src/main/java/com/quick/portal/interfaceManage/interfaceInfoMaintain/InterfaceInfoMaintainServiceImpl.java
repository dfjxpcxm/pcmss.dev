 ...
 * <h3>描述 : InterfaceInfoMaintain服务实现类</h3>
 ...
 */
 @Transactional
 @Service("interfaceInfoMaintainService")
public class InterfaceInfoMaintainServiceImpl extends SysBaseService<InterfaceInfoMaintainDO> implements IInterfaceInfoMaintainService {
    
    /**
     * 构造函数
     */
    public InterfaceInfoMaintainServiceImpl() {
    ...
    @Autowired
    private IInterfaceInfoMaintainDao dao;
     ...
     */
    @Override
    public DataStore save(InterfaceInfoMaintainDO entity) {
